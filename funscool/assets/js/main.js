...
(function () {
  ...
  var SR = {
    ...
    joy_eyebrow:"Radost — svakog dana", joy_title:"Praznici, projekti i događaji u FunsCool-u",
    joy_sub:"Život vrtića FunsCool u Beogradu nije samo aktivnosti i uobičajen ritam dana. Deca učestvuju u praznicima i pozorišnim predstavama, kuvaju sa vaspitačima, prave projekte, idu na izlete i upoznaju tradicije različitih kultura.",
  ...
  var EN = {
    ...
    joy_eyebrow:"Joy — every single day", joy_title:"Celebrations, projects and events at FunsCool",
    joy_sub:"Life at FunsCool in Belgrade is more than lessons and a daily routine. Children take part in celebrations and theatre performances, cook together with teachers, create projects, go on excursions and get to know the traditions of different cultures.",
